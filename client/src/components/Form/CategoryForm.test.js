...
describe("CategoryForm", () => {
    ...
    it("should update input value on change", async () => {
        ...
        expect(setValue).toHaveBeenCalledWith("Chairs"); // Ensure setValue is called with "Chairs"
    
        await waitFor(() => {
            // Simulate the input being updated by updating the value
            expect(value).toBe("Chairs");
        });
    });
